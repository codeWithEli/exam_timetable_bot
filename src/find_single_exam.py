                ...
                async with session.get(link) as response:
                    ...
                    if table:
                        ...
                        for venue in venues:
                            ...
                            if len(venue_id_range) == 2 and binary_search(
                                list(
                                    range(
                                ...
                                exact_venues_details[course_name] = {
